...
public class Castle
{
	 ...
	 *            King of the player
	 * @param xRel
	 *            relative movement of the King on the X axis
	 * @param yRel
	 *            relative movement of the King on the Y axis
	 * @param isDebug
	...
	public boolean castleCheck(King p, int xRel, int yRel, boolean isDebug, AbstractPiece[][] gamestate, int moveNo)
	{
		if (p.getWasMoved() == false)
		{
			...
			{ //castle to the right
				...
				if (p.getColor().equalsIgnoreCase("white") && utils.getPiece(7, 0, isDebug, gamestate) instanceof Rook
						&& ((Rook) utils.getPiece(7, 0, isDebug, gamestate)).getWasMoved() == false)
				{
					//check if all the spaces are free
					if (utils.getPiece(5, 0, isDebug, gamestate) instanceof BlankPiece
							&& utils.getPiece(6, 0, isDebug, gamestate) instanceof BlankPiece)
					{
				...
				if (p.getColor().equalsIgnoreCase("black") && utils.getPiece(7, 7, isDebug, gamestate) instanceof Rook
						&& ((Rook) utils.getPiece(7, 7, isDebug, gamestate)).getWasMoved() == false)
				{
					//check if all the spaces are free
					if (utils.getPiece(5, 7, isDebug, gamestate) instanceof BlankPiece
							&& utils.getPiece(6, 7, isDebug, gamestate) instanceof BlankPiece)
					{
			...
			{ //castle to the left
				//castle for white and rook not moved
				if (p.getColor().equalsIgnoreCase("white") && utils.getPiece(0, 0, isDebug, gamestate) instanceof Rook
						&& ((Rook) utils.getPiece(0, 0, isDebug, gamestate)).getWasMoved() == false)
				{
					//check if all the spaces are free
				...
				//castle for black and rook not moved
				if (p.getColor().equalsIgnoreCase("black") && utils.getPiece(0, 7, isDebug, gamestate) instanceof Rook
						&& ((Rook) utils.getPiece(0, 7, isDebug, gamestate)).getWasMoved() == false)
				{
					//check if all the spaces are free
