...
public class music {
	...
	public music() {
		ulrchessmove = this.getClass().getClassLoader().getResource("resourses.music/chessmove.wav");
		chessmove	  = new AudioClip(ulrchessmove.toExternalForm());
		
		ulrBomb = this.getClass().getClassLoader().getResource("resourses.music/Bomb.wav");
		Bomb = new AudioClip(ulrBomb.toExternalForm());
		
        ulrMiniPromote  = this.getClass().getClassLoader().getResource("resourses.music/Mini-Promote.wav");
		MiniPromote  = new AudioClip(ulrMiniPromote.toExternalForm());
		
		ulrTeleport = this.getClass().getClassLoader().getResource("resourses.music/Teleport.wav");
