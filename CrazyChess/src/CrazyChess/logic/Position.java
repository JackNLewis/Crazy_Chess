...
/**
 * This class is used to hold position of the piece on the board. It also has getters and setters for it.
 * 
 * The positions are represented by x and y coordinates. For example, square A1 would be coordinate (0,0), H8 would be (7,7) and so on.
 *
 */
public class Position implements Serializable
{
	 ...
	 *
	 * @param pos
	 *            position to be checked against this Position object
